...
export default function VendeurCommandesPage() {
  ...
  const totalRevenue = orders.reduce((acc, o) => acc + o.net, 0)
  const totalCommission = orders.reduce((acc, o) => acc + o.commission, 0)
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            ...
            <div className="card p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold text-gray-900">{formatPrice(orders.reduce((acc, o) => acc + o.amount, 0), currency)}</p>
            ...
            <div className="card p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Revenus nets</p>
                </div>
              </div>
            </div>
            <div className="card p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold text-gray-900">{formatPrice(totalCommission, currency)}</p>
              ...
              <table className="w-full">
                <thead className="bg-gray-50 border-b border-gray-100">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-left text-sm font-semibold text-gray-600">Net</th>
                ...
                <tbody className="divide-y divide-gray-100">
                  {orders.map((order) => (
                    <tr key={order.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        <span className="font-medium text-gray-900">{formatPrice(order.amount, currency)}</span>
                      </td>
                      <td className="px-6 py-4">
                        <div>
                          <p className="font-semibold text-accent-600">{formatPrice(order.net, currency)}</p>
                          <p className="text-xs text-gray-500">-{formatPrice(order.commission, currency)}</p>
                        </div>
                      </td>
                      <td className="px-6 py-4">
